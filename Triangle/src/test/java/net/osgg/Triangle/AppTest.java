...
/*
    ...
    public void TC06() {
    	TriangleUtils t = new TriangleUtils();
    	String a = "1", b = "4", c = "3";
    	assertTrue( t.getTriangleType(a, b, c).contains("los valores ingresados no corresponden con los de un triángulo"));
    }
	...
	*/
    ...
    public void TC09() {
    	TriangleUtils t = new TriangleUtils();
    	String a = "a", b = "7", c="4";
    	assertTrue( t.getTriangleType(a,b,c).contains("los tres valores a ingresar deben ser números enteros"));
    }
